...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 11, 2025 lúc 10:35 AM
...
(1, 'Tai nghe Sony WH-1000XM4', 'Tai nghe không dây chống ồn cao cấp với chất lượng âm thanh tuyệt vời và thời lượng pin lên đến 30 giờ', 8399760.00, 24, 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=400&h=400&fit=crop', '2025-05-26 08:11:52', '2025-06-11 07:12:17'),
...
--
-- Cấu trúc bảng cho bảng `artist_products`
--
...
--
-- Đang đổ dữ liệu cho bảng `artist_products`
--
...
(16, 4, '2025-06-11 06:28:21', 800000.00, 'wallet', NULL, -1, 0.00, 800000.00),
(17, 4, '2025-06-11 07:12:17', 9199760.00, 'wallet', NULL, 0, 0.00, 9199760.00),
(18, 4, '2025-06-11 08:28:21', 800000.00, 'cash', NULL, 0, 0.00, 800000.00);
...
(16, 16, 1, 'Abbey Road - The Beatles', 800000.00, 1, 800000.00, 'product', 1, 'Abbey Road - The Beatles', 800000.00),
(17, 17, 4, 'Sgt. Pepper\'s Lonely Hearts Club Band - The Beatles', 800000.00, 1, 800000.00, 'product', 4, 'Sgt. Pepper\'s Lonely Hearts Club Band - The Beatles', 800000.00),
(18, 17, 1, 'Tai nghe Sony WH-1000XM4', 8399760.00, 1, 8399760.00, 'accessory', 1, 'Tai nghe Sony WH-1000XM4', 8399760.00),
(19, 18, 4, 'Sgt. Pepper\'s Lonely Hearts Club Band - The Beatles', 800000.00, 1, 800000.00, 'product', 4, 'Sgt. Pepper\'s Lonely Hearts Club Band - The Beatles', 800000.00);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `order_stages`
--
...
(1, 1, 'Abbey Road - The Beatles', 800000.00, 37, 'Album huyền thoại của The Beatles được phát hành năm 1969. Bao gồm các ca khúc nổi tiếng như \"Come Together\", \"Something\", \"Here Comes the Sun\". Đây là album cuối cùng được thu âm bởi ban nhạc.', 'https://upload.wikimedia.org/wikipedia/en/4/42/Beatles_-_Abbey_Road.jpg', '2025-05-23 06:59:34', '2025-05-25 07:59:37'),
...
(4, 1, 'Sgt. Pepper\'s Lonely Hearts Club Band - The Beatles', 800000.00, 28, 'Album thứ tám của The Beatles, được phát hành năm 1967. Được coi là một trong những album có ảnh hưởng nhất trong lịch sử âm nhạc rock.', 'https://upload.wikimedia.org/wikipedia/en/5/50/Sgt._Pepper%27s_Lonely_Hearts_Club_Band.jpg', '2025-05-21 06:59:34', '2025-05-26 02:09:59'),
...
(26, 4, 3, NULL, 1, 'product', '2025-06-11 08:19:02'),
(27, 4, 2, NULL, 1, 'product', '2025-06-11 08:32:04');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `support_replies`
--
...
--
-- Đang đổ dữ liệu cho bảng `support_replies`
--
...
(4, 2, 'demo', '$2y$10$pfM2AxZq43rKAi0VvygdC.G/ovCRZx1xE2xWyTWD5cinAjT.CUt12', 'demo@gmail.com', 'De Mo', 'Nữ', '1111111111', '2025-06-11 07:12:17', 971560480.00, 'Khu Phố 6, Hàn Thuyên\n2025-06-10 21:07:33 - Nạp 50000₫ - Order: 58');
...
--
-- Chỉ mục cho bảng `artist_products`
--
...
--
-- Chỉ mục cho bảng `support_replies`
--
...
--
-- AUTO_INCREMENT cho bảng `artist_products`
--
ALTER TABLE `artist_products`
  MODIFY `artist_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `authentication`
--
ALTER TABLE `authentication`
...
--
-- AUTO_INCREMENT cho bảng `support_replies`
--
ALTER TABLE `support_replies`
...
--
-- Các ràng buộc cho bảng `authentication`
--
ALTER TABLE `authentication`
